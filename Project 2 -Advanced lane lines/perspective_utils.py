...
def get_birdeye_frame(img, verbose = False):
    ...
    if verbose:
        ...
        axarray[1].set_title('Before Perspective Transform')
...
if __name__ == '__main__':
    ...
    for test_img in glob.glob('test_images/*.jpg'):
        ...
        img_birdeye, M, Minv, = get_birdeye_frame(cv2.cvtColor(img_undistorted, cv2.COLOR_BGR2RGB), verbose = True)
